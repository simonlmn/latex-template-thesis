...
%
\documentclass[ngerman,a4paper,11pt,twoside,openright,cleardoublepage=empty,parskip=half]{scrreprt}
...
% Fixt Unverträglichkeiten zwischen KOMA-Script 3 und anderen Paketen (u.a. float)
\usepackage{scrhack}
